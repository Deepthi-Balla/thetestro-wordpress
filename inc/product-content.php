 ...
 * Arrow icons are always removed on hero CTAs site-wide.
 *
	...
	$pages = array(
		...
		'automated-web-application-testing' => array(
			...
			'sections' => array(
				...
				/* AI-Powered Web Test Authoring — Framer gP2xF9DBw light timeline (global pattern). */
				array(
					'type'          => 'pipeline',
		...
		'test-management-software' => array(
			...
			'sections' => array(
				...
				/* Framer Cpi3p8V3C — Home How It Works process-flow; three-lines header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer XrnURSvka — numbered safeguards + repo panel; three-lines header. */
				array(
					'type'          => 'tm-compose',
				...
				/* Framer FNVhR0CPg — Feature Card 2; three-lines header. */
				array(
					'type'          => 'tm-compose',
					...
					'intro'         => __( 'Two-Way Sync With Jira', 'testro' ),
				...
				/* Framer hATvXzKjt — 4 safeguards + sources panel; three-lines header. */
				array(
					'type'          => 'tm-compose',
					...
					'intro'         => __( 'Test Case Generation From Whatever You Already Have', 'testro' ),
				...
				/* Framer rVthhEMHN — Feature Card 2 tint; three-lines header. */
				array(
					'type'          => 'tm-compose',
				...
				/* Framer fE2FYJu0k — Feature Card 2 tint; three-lines header. */
				array(
					'type'          => 'tm-compose',
				...
				/* Framer knJeiaX7w — Feature Card 2 white on tint; three-lines header. */
				array(
					'type'          => 'tm-compose',
		...
		'self-healing-test-automation-tool' => array(
			...
			'sections' => array(
				...
				/* Home How It Works process-flow (cyan markers + navy→cyan connector). */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer qJZyhirUN — tint bg, media left; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'heal-compose',
				...
				/* Framer L2pF5R8c1 — navy→cyan band, media left; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'heal-compose',
				...
				/* Framer nsPTPDVUm — tint bg, media right; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'heal-compose',
				...
				/* Same Debug Test Failures Faster rows as automated-web-application-testing. */
				array(
					'type'          => 'outcomes',
		...
		'test-development' => array(
			...
			'sections' => array(
				...
				/* Framer pYO4jfzAN — three-lines header + DevOps timeline + bottom text. */
				array(
					'type'          => 'td-compose',
					'id'            => 'agentic-test-development',
					'variant'       => 'proof-split',
					'header_style'  => 'three-lines',
					'eyebrow'       => __( 'Agentic Test Development, Built for Speed', 'testro' ),
					'title'         => __( 'Tests Built Before You\'d Even Finish Typing Them by Hand', 'testro' ),
				...
				/* Framer p5fDSvGbK — chat demo left; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'td-compose',
				...
				/* Framer yifVABAd4 — QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'td-compose',
					'id'            => 'who-builds-tests',
					'variant'       => 'role-rows',
				...
				/* Framer afm6CfKCm — media left, tint; QI plain rows (no number badges). */
				array(
					'type'          => 'td-compose',
				...
				/* Framer JrgDHmMIk — copy left, media right, white; QI plain rows (no number badges). */
				array(
					'type'          => 'td-compose',
				...
				/* Framer tukLMnnn4 — media left, white; QI plain rows (no number badges). */
				array(
					'type'          => 'td-compose',
				...
				/* Framer rwqNRMuSa — copy left, media right, white; QI plain rows (no number badges). */
				array(
					'type'          => 'td-compose',
					'id'            => 'extend-any-test',
					'variant'       => 'feature-split',
				...
				/* Framer MGaZaREz3 — media left, tint + cyan outro; QI plain rows (no number badges). */
				array(
					'type'          => 'td-compose',
				...
				/* Framer eMaQR9czK — faq-label header (mono label + title + intro) on gradient. */
				array(
					'type'          => 'td-compose',
					'id'            => 'one-platform-every-team',
					'variant'       => 'platform-band',
					'tone'          => 'dark',
					'header_style'  => 'faq-label',
				...
				/* Framer uH0gRXAZL — three-lines header; gradient pills. */
				array(
					'type'          => 'td-compose',
		...
		'test-execution' => array(
			...
			'sections' => array(
				...
				/* Framer yN6gXMHHF — QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'te-compose',
				...
				/* Framer p0qxIchTZ — parallel split; QI numbered rows; three-lines header. */
				array(
					'type'          => 'te-compose',
				...
				/* Framer E4q4f9e9P — QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'te-compose',
				...
				/* Framer baVPp79i2 — media left; QI plain rows (no number badges). */
				array(
					'type'          => 'te-compose',
				...
				/* Framer UBrp_2di0 — copy left, media right; QI plain rows (no number badges). */
				array(
					'type'          => 'te-compose',
				...
				/* Framer PXCcYzi8C — QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'te-compose',
		...
		'ci-cd-integration' => array(
			...
			'sections' => array(
				...
				/* What CI/CD Testing Actually Means — light timeline + three-lines header. */
				array(
					'type'              => 'pipeline',
				...
				/* Home How It Works process-flow (cyan markers + navy→cyan connector, white bg). */
				array(
					'type'          => 'cicd-compose',
				...
				/* Framer w3nQcw4BE — 2×2 Feature Card 2 with icons. */
				array(
					'type'          => 'cicd-compose',
				...
				/* Framer zdTgJC7ux — native integrations hub + tool badges; three-lines header. */
				array(
					'type'          => 'cicd-compose',
				...
				/* Testing at Every Stage — Feature Card 2 ×3 with icons; three-lines header. */
				array(
					'type'          => 'cicd-compose',
				...
				/* Framer PmfPKoUrn — QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'cicd-compose',
		...
		'playwright-test-automation' => array(
			...
			'sections' => array(
				...
				/* Framer t_YcmsBQn — Feature Card 2 ×3 + outro; three-lines header. */
				array(
					'type'          => 'pw-compose',
				...
				/* Same Debug Test Failures Faster rows; three-lines header. */
				array(
					'type'          => 'outcomes',
				...
				/* Framer gIGcXVwIm — list + striped media right; QI numbered rows; three-lines header. */
				array(
					'type'          => 'pw-compose',
				...
				/* Framer ltPvQ7R1I — Feature Card 2 ×3; three-lines header. */
				array(
					'type'          => 'pw-compose',
				...
				/* Framer eHOhX_KBj — Feature Card 2 ×3; three-lines header. */
				array(
					'type'          => 'pw-compose',
				...
				/* Framer FUxiVljLB — Feature Card 2 ×3. */
				array(
					'type'          => 'pw-compose',
				...
				/* Framer vP9u1VNl8 — media left + list; QI plain rows (no number badges); header/outro end-aligned. */
				array(
					'type'          => 'pw-compose',
				...
				/* Framer MglD5YBSg — 2×2 Feature Card 2; three-lines header. */
				array(
					'type'          => 'pw-compose',
		...
		'reporting-analytics' => array(
			...
			'sections' => array(
				...
				/* Framer Z1LzD5Vwb — bordered white industry cards ×3 + outro; three-lines header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer W3JTCFBiQ — 3 stakeholder cards + outro; three-lines header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer jemO7XPxH — tint feature-split + outro; QI numbered rows. */
				array(
					'type'          => 'ra-compose',
				...
				/* Home How It Works process-flow; three-lines header. */
				array(
					'type'          => 'ra-compose',
		...
		'regression-test-automation' => array(
			...
			'sections' => array(
				...
				/* Framer rb7cJO0br — white coverage-split + outro; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 're-compose',
					'id'            => 'ai-root-cause-analysis',
					'variant'       => 'coverage-split',
				...
				/* Framer iqVXPQlnc — tint exec-split ×3; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer b3PcYdgab — white exec-split ×5; QI numbered rows; preserve Onc typo + duplicate 03 stages. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer p3ki61T6U — tint workflow-grid, 5 CI pills + outro; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer XN1266NoF — white exec-split ×3; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer CRKmxSvOg — tint impact-rows ×4; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
		...
		'ai-automated-sanity-testing' => array(
			...
			'sections' => array(
				...
				/* Framer mWSvuCNt4 — white exec-split ×3 + outro; QI numbered rows; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer zB8STcV_X — white feature-cards ×3 + intro_extra + outro; three-lines header; flow arrows. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer vJxxRDaKW — tint exec-split ×4; QI numbered rows (AI Quality Intelligence left rail); preserve duplicate 03. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer Zfz4hCgni — white impact-rows ×3; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer UBblbyjJf — tint feature-cards ×3; three-lines header. */
				array(
					'type'          => 'bf-compose',
					...
					'columns'       => 3,
					'header_style'  => 'three-lines',
					'title'       => __( 'Verification That Happens Without Anyone Asking For It', 'testro' ),
					'eyebrow'         => __( 'Continuous Sanity Testing in Your Pipeline', 'testro' ),
				...
				/* Fast Reporting — same light timeline as AI-Powered Web Test Authoring (global pipeline pattern). */
				array(
					'type'          => 'pipeline',
					'id'            => 'fast-reporting-for-fast-decisions',
					'eyebrow'       => __( 'Fast Reporting for Fast Decisions', 'testro' ),
					'title'         => __( 'Know in Minutes Whether to Proceed', 'testro' ),
					'heading_level' => 2,
					'align'         => 'start',
					'variant'       => 'spotlight',
					'layout'        => 'timeline',
		...
		'automated-functional-testing' => array(
			...
			'sections' => array(
				...
				/* Framer zZDpG0WXl — Coverage Engine: header ABOVE, then rows | media; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer qGQlOHNu6 — Home How It Works process-flow (cyan markers + navy→cyan connector). */
				array(
					'type'          => 'ra-compose',
					'id'            => 'how-it-works',
					'variant'       => 'process-flow',
				...
				/* Framer WWlsTIHnB — Coverage Engine header-above + rows | media; QI numbered rows; three-lines header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer EtEY2m6NI — white exec-split ×3; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer LTHvcrE0P — tint #f4f9ff Coverage Engine header-above + rows | media; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer kLqof_iiu — Natural Language (demo | copy), white; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'td-compose',
				...
				/* Framer cGeDAwu5C — tint Coverage Engine header-above + rows | media; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer cNhRXJJNs — Natural Language (demo | copy) + outro; QI numbered rows; shared bottom-text. */
				array(
					'type'          => 'td-compose',
				...
				/* Framer EB1DfudZM — white workflow-grid ×5; three-lines header. */
				array(
					'type'          => 'bf-compose',
		...
		'end-to-end-testing' => array(
			...
			'sections' => array(
				...
				/* Framer ETYHprakO — Home How It Works process-flow (cyan markers + navy→cyan connector). */
				array(
					'type'          => 'ra-compose',
					'id'            => 'how-it-works',
					'variant'       => 'process-flow',
				...
				/* Framer MPzEEECl5 — white workflow-grid ×5; three-lines header. */
				array(
					'type'          => 'bf-compose',
					'id'            => 'fits-into-your-existing-workflow',
					'variant'       => 'workflow-grid',
		...
		'use-cases' => array(
			...
			'sections' => array(
				...
				/* Framer hHoq7UiQQ — #F1F8FD coverage header + rows | media; QI numbered rows; three-lines header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer WNJgAim6H — Home How It Works process-flow (cyan markers + navy→cyan connector); three-lines header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer o1DnMNjyA — navy→cyan coverage rows; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer AlYrKNxVv — #F4F9FF feature-cards ×3; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer QyCrwrNz9 — #F4F9FF exec-split ×6; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
		...
		'ai-powered-integration-testing' => array(
			...
			'sections' => array(
				...
				/* Framer eb99B55hs — tint Intelligent Automation Engine; white industry cards ×3; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer Uy8J0u47n — white exec-split ×6; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer qftTQdQHe — Home How It Works process-flow (cyan markers + navy→cyan connector). */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer AcCjRV3dr — tint exec-split ×5; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer xOE5TnIU1 — Coverage Engine brand gradient; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer gvuARzFZe — white Solutions by Industry; tint cards ×4; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer UjRIofgBk — white horizontal workflow-grid ×4; three-lines header. */
				array(
					'type'          => 'bf-compose',
					'id'            => 'cicd-integration-built-in',
					'variant'       => 'workflow-grid',
				...
				/* Framer Us95kOVm1 — white exec-split ×4; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
		...
		'retail-ecommerce' => array(
			...
			'sections' => array(
				...
				/* Framer xQ20qZpn1 — white exec-split; QI numbered rows; three-lines header. */
				array(
					'type'          => 're-compose',
				...
				array(
					...
					'variant'       => 'compare-table',
					'tint'          => true,
					'title'       => __( 'What Changes When Testing Scales With Your Catalog', 'testro' ),
					'eyebrow'         => __( 'Manual Investigation vs. AI Test Analytics', 'testro' ),
					'first_label'   => __( 'Category', 'testro' ),
				...
				/* Framer SjNpS9Qfb — Coverage Engine (plain English); QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 're-compose',
				...
				/* Framer YlVLwz29e — white exec-split; QI numbered rows; three-lines header. */
				array(
					'type'          => 're-compose',
				...
				/* Framer QYovDcP36 — tint exec-split; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 're-compose',
				...
				/* Framer SSZqQkRLf — white exec-split; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 're-compose',
				...
				/* Framer U0G3Yn9kA — Coverage Engine (visual regression); QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 're-compose',
				...
				/* Framer XQa20sDx9 — white workflow-grid, 5 tiles; three-lines header. */
				array(
					'type'          => 're-compose',
					'id'            => 'fits-existing-workflow',
					'variant'       => 'workflow-grid',
		...
		'healthcare' => array(
			...
			'sections' => array(
				...
				/* Framer ZEWIc6Ujv — tint exec-split + striped media + bottom text. */
				array(
					'type'          => 'bf-compose',
					...
					'intro_body'    => __( 'Patient data is sensitive. A security gap can mean real harm, not just a bad review. Clinical workflows involve many systems talking to each other.', 'testro' ),
					...
					'outro'         => __( 'This is why generic healthcare software testing tools fall short. Healthcare needs a platform built around these constraints. Not one that treats them as an afterthought, added on once the core product is already built. The teams that get this right start with compliance and stability as first-class requirements, not a checklist item at the end of a sprint.', 'testro' ),
					'outro_align'   => 'end',
					'heading_level' => 2,
				),
				...
				/* Framer OLK_6BFBL — white workflow-grid, 7 tiles; three-lines header. */
				array(
					'type'          => 'bf-compose',
		...
		'banking-finance' => array(
			...
			'sections' => array(
				...
				/* Framer DBABUzJT_ — white exec-split, 4 steps; QI numbered rows. */
				array(
					'type'          => 'bf-compose',
				...
				array(
					...
					'card_fill'     => 'tint',
					'columns'       => 3,
					'eyebrow'         => __( 'AI agents at every stage of testing', 'testro' ),
				...
				/* Framer OZR8pVFIF — light exec-split; QI numbered rows + three-lines header + bottom text. */
				array(
					'type'          => 'bf-compose',
					...
					'outro'         => __( 'Full traceability: clear logs to back up audits and release checks. BFSI testing isn\'t just about catching bugs. It\'s about proving you caught them, with real evidence to show for it.', 'testro' ),
					'outro_align'   => 'end',
					'heading_level' => 2,
					'items'         => array(
						array(
				...
				/* Framer yCiOpUmtE — white workflow-grid; three-lines header. */
				array(
					'type'          => 'bf-compose',
					'id'            => 'fits-existing-workflow',
					'variant'       => 'workflow-grid',
		...
		'travel-and-hospitality' => array(
			...
			'sections' => array(
				...
				/* Framer ueWdOKxjL — tint feature-split, media left; QI plain rows (no number badges). */
				array(
					'type'          => 'td-compose',
				...
				/* Framer HOJiTFmk1 — white workflow-grid, 4 tiles 2×2; three-lines header. */
				array(
					'type'          => 'bf-compose',
					'id'            => 'fits-existing-workflow',
					'variant'       => 'workflow-grid',
		...
		'insurance' => array(
			...
			'sections' => array(
				...
				array(
					...
					'outro'         => __( 'Skipping the hard cases misses the exact spots that cause the most support calls.', 'testro' ),
					'outro_align'   => 'end',
					'heading_level' => 2,
					'items'         => array(
						array(
		...
		'microsoft-dynamics-365-test-automation' => array(
			...
			'sections' => array(
				...
				/* Framer ZGxTACb1t — white section; industry cards fill #F4F9FF; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer CErkMQHpa — tint #F4F9FF industry cards ×4; three-lines header. */
				array(
					'type'          => 'bf-compose',
		...
		'salesforce-test-automation' => array(
			...
			'sections' => array(
				...
				/* Framer rVnsfeVEm — white; industry cards #F4F9FF + PathNode; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer XRpLoxrnu — #F4F9FF industry cards ×3 white fill + PathNode; three-lines header. */
				array(
					'type'          => 'bf-compose',
					...
					'intro_extra'   => __( 'This is Salesforce automation testing built so QA staff, admins, and business users can all pitch in. Not just engineers who know Selenium.', 'testro' ),
					'heading_level' => 2,
					'items'         => array(
						array(
							'icon'        => 'video',
				...
				/* Framer vZMj0tyqX — white industry cards ×3 tint fill + PathNode; three-lines header. */
				array(
					'type'          => 'bf-compose',
					...
					'intro_extra'   => __( 'This is what real AI Salesforce testing should mean. Stability that holds through the exact kind of change that breaks everything else.', 'testro' ),
					'heading_level' => 2,
					'items'         => array(
						array(
							'icon'        => 'scan-eye',
				...
				/* Framer JtDc0a2JA — #F4F9FF industry cards ×4; three-lines header. */
				array(
					'type'          => 'bf-compose',
					...
					'intro_extra'   => __( 'One plain-English flow can cover all it. No separate siloed suite for every cloud.', 'testro' ),
					'heading_level' => 2,
					'items'         => array(
						array(
							'icon'        => 'target',
				...
				/* Framer TXZptkcf4 — #F4F9FF feature-split; QI numbered rows. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer edA6tAFbH — white capability-split; QI numbered rows. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer brMA3AvwX — #F4F9FF feature-split ×4; QI numbered rows. */
				array(
					'type'          => 'ra-compose',
		...
		'oracle-testing' => array(
			...
			'sections' => array(
				...
				/* Framer oeYSA8wM4 — soft #EAF3FC feature-split; FAQ-label header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer l80irKL3X — white feature-split; FAQ-label header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer uhcR8txql — #F4F9FF industry cards ×4; supporting frames visible:false; FAQ-label header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer FClEn5Zqw — white capability-split; QI numbered rows; three-lines header. */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer mFDxKMu9X — #F4F9FF stacked feature-split; FAQ-label header. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer SY_029mkM — white; tint industry cards; three-lines header. */
				array(
					'type'          => 'bf-compose',
		...
		'sap-testing' => array(
			...
			'sections' => array(
				...
				/* Framer o66aisMRx — #F4F9FF Natural Language; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer SBpJKZsdD — brand exec-split; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer Kj1eOem2b — #F4F9FF Natural Language; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer hNqMkTJTG — #F4F9FF Natural Language; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
		...
		'workday-testing' => array(
			...
			'sections' => array(
				...
				/* Framer RFgSO7sdk — white Natural Language; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer ldYhIdEL4 — white Natural Language; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer aB3J1ZEis — #F4F9FF Natural Language; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
		...
		'servicenow-testing' => array(
			...
			'sections' => array(
				...
				/* Framer sjGHSEDxV — white Natural Language title|rail ×4; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Home How It Works process-flow (cyan markers + navy→cyan connector); duplicate stage 03 kept. */
				array(
					'type'          => 'ra-compose',
					'id'            => 'how-teams-get-started',
					'variant'       => 'process-flow',
				...
				/* Framer co2PSPBck — #F1F8FD Natural Language title|rail ×6; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer RKRXTV1fn — white Natural Language title|rail ×3; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'          => 'bf-compose',
				...
				/* Framer Bc3LX6vKt — #F1F8FD media|rail-header; QI numbered rows (AI Quality Intelligence left rail). */
				array(
					'type'            => 'ra-compose',
				...
				/* Framer QlR8yjHeF — white Coverage Engine: three-lines header + list|media; QI numbered rows. */
				array(
					'type'          => 'ra-compose',
				...
				/* Framer dYGwqjTAY — #F4F9FF Coverage Engine: header + media|list; QI numbered rows; italic Supporting Copy. */
				array(
					'type'          => 'ra-compose',
