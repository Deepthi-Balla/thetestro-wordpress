...
function testro_icon_paths() {
	...
	$icons = array(
		...
		'piggy-bank'    => '<path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.4-7.4-.8-9.6 2-2.4 3-1.8 7 1.4 9.2"/><path d="M7.5 12.5A2.5 2.5 0 0 1 10 10"/><path d="M15 8.5V7a1.5 1.5 0 0 1 3 0v1.5"/><path d="M8 19v2M16 19v2"/><path d="M2 12v2a8 8 0 0 0 16 0v-1"/><path d="M19 10a2 2 0 0 0 2 2v1"/>',
		'briefcase'     => '<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><path d="M12 12v.01"/>',
		'mouse-pointer' => '<path d="M4 4l7.07 17 2.51-7.39L21 11.07z"/><path d="M13 13l6 6"/>',
