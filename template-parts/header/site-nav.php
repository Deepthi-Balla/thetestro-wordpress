...
?>
	<nav class="testro-nav" aria-label="<?php esc_attr_e( 'Primary', 'testro' ); ?>">
		<div class="testro-nav__inner testro-container">
			<div class="testro-nav__left">
				...
				<div id="testro-primary-menu" class="testro-nav__menu">
					...
					<div class="testro-nav__actions testro-nav__actions--mobile">
						<?php
						get_template_part(
			...
			<div class="testro-nav__actions testro-nav__actions--desktop">
				<?php
				get_template_part(
					'template-parts/components/primary-button',
					null,
